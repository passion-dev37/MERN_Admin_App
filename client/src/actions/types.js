...
export const GITHUB_USER_LOADED = 'GITHUB_USER_LOADED';
export const GITHUB_USER_ADAPTED = 'GITHUB_USER_ADAPTED';

// GITHUB API
export const MY_GITHUB_USER_LOADED = 'MY_GITHUB_USER_LOADED';
export const MY_GITHUB_USER_LOAD_FAILURE = 'MY_GITHUB_USER_LOAD_FAILURE';
